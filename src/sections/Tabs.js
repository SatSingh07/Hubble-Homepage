...
export default function Tabs() {
    ...
    const tabBodyStyle = "flex justify-between"
    ...
    return(
        <section className="py-20">
            <div className="container">
                <h3 className="text-[48px] font-normal text-center leading-[1.1em] mt-8 mx-auto">Customize to your use case</h3>

                <ul className="bg-darkBlue border-white border-[1px] border-opacity-10 rounded-lg flex justify-between w-[915px] mt-20 mx-auto p-2 relative z-[1] translate-y-[50%]"> 
                    <li className="relative overflow-visible">
                        ...
                        <img src={purpleBlur} alt="" className={activeTab === 1 ? `${navItemHighlight}` : `${navItemHighlight} hidden`} />
                    </li>
                    ...
                    <li className="relative overflow-visible">
                        ...
                        <img src={purpleBlur} alt="" className={activeTab === 2 ? `${navItemHighlight}` : `${navItemHighlight} hidden`} />
                    </li>
                    ...
                    <li className="relative overflow-visible">
                        ...
                        <img src={purpleBlur} alt="" className={activeTab === 3 ? `${navItemHighlight}` : `${navItemHighlight} hidden`} />
                    </li>
                    ...
                    <li className="relative overflow-visible">
                        ...
                        <img src={purpleBlur} alt="" className={activeTab === 4 ? `${navItemHighlight}` : `${navItemHighlight} hidden`} />
                    </li>
                </ul>               
                ...
                <div className="bg-darkBlue backdrop-blur-[50px] border-white border-[1px] border-opacity-10 rounded-2xl overflow-hidden">
                    <div className={activeTab === 1 ? `${tabBodyStyle}` : `${tabBodyStyle} hidden`}>
                        <div className="w-[460px] flex flex-col gap-3 justify-center my-12 pl-16">
                        ...
                        <img src={vmImage} alt="Vulnerability Management" className="w-1/2" />
                    ...
                    <div className={activeTab === 2 ? `${tabBodyStyle}` : `${tabBodyStyle} hidden`}>
                        ...
                        <img src={vmImage} alt="Security Operations" className="w-1/2" />
                    ...
                    <div className={activeTab === 3 ? `${tabBodyStyle}` : `${tabBodyStyle} hidden`}>
                        ...
                        <img src={vmImage} alt="Data Governance" className="w-1/2" />
                    ...
                    <div className={activeTab === 4 ? `${tabBodyStyle}` : `${tabBodyStyle} hidden`}>
                        ...
                        <img src={vmImage} alt="IT Blind Spots" className="w-1/2" />
